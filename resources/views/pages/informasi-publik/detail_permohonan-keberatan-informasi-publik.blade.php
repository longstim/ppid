          ...
          <div class="table-responsive">
            <table class="table table-hover">
              ...
              <tr>
                ...
                <td>:</td>
                <th>{{$detail->upload_dokumen}} <a href="{{asset('file/permohonan-keberatan-informasi/identitas/'.$detail->upload_dokumen)}}" target="_blank">&nbsp;&nbsp; <span class="badge bg-info"> Download</span></a></th>
              </tr>
              <tr>
                <td>Alamat</td>
                <td>:</td>
          ...
          <div class="card-body">
              ...
              <div class="form-group col-md-12">
                ...
                @php
                  ...
                  {
                @endphp
                  <p> <a href="{{asset('file/permohonan-keberatan-informasi/tindak-lanjut/'.$detail->bukti_tindaklanjut)}}" class="text-info" target="_blank"><i class="fas fa-file-pdf text-info"></i> {{$detail->bukti_tindaklanjut}}</a></p>
                @php
                }
                else
                {
