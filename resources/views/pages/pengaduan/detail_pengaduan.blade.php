          ...
          <div class="card-body">
              ...
              <div class="form-group col-md-12">
                ...
                @php
                  ...
                  {
                @endphp
                  <p> <a href="{{asset('file/pengaduan/tindak-lanjut/'.$detail->bukti_tindaklanjut)}}" class="text-info" target="_blank"><i class="fas fa-file-pdf text-info"></i> {{$detail->bukti_tindaklanjut}}</a></p>
                @php
                }
                else
                {
