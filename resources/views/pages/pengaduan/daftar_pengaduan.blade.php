                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" id="dropdown-action-id">
                        ...
                        @php
                            ...
                            {
                        @endphp
                            <a class="dropdown-item" href="#" href="#" data-toggle="modal" data-target="#modal-cancel">Batal</a>
                        @php
                        }
                        @endphp
                ...
                <form role="form" id="tindaklanjut" method="post" action="{{url('update-pengaduan-solved')}}" enctype="multipart/form-data">
                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title"><i class="fas fa-check"></i><b> &nbsp;Tindak Lanjut Pengaduan Masyarakat</b></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                      <div class="row">
             ...
             <div class="row">
                ...
                <form role="form" id="cancel-modal" method="post" action="{{url('update-pengaduan-cancel')}}">
                  ...
                  <div class="card card-danger">
                    <div class="card-header">
                      <h3 class="card-title"><i class="fas fa-times-circle"></i><b> &nbsp;Keterangan Pembatalan Pengaduan Masyarakat</b></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                      <div class="row">
