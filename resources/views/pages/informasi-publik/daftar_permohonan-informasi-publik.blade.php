          ...
          <table id="example1" class="table table-hover">
            ...
            @foreach($pib as $data)  
               <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <a href="{{url('detail-permohonan-informasi-publik/'.$data->id)}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Detail" type="button" ><i class="fas fa-search"></i>
                      </a>&nbsp;
                      ...
                      <div class="dropdown-menu" id="dropdown-action-id">
                        ...
                        @php
                            ...
                            {
                        @endphp
                            <a class="dropdown-item" href="{{url('update-permohonan-in-progress/'.$data->id)}}">Proses</a>
                        @php
                            }
                            else
                            {
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
             <div class="row">
                ...
                <div class="col-md-12">
                <!-- jquery validation -->
                <form role="form" id="tindaklanjut" method="post" action="{{url('update-permohonan-solved')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
             <div class="row">
                ...
                <div class="col-md-12">
                <!-- jquery validation -->
                <form role="form" id="cancel-modal" method="post" action="{{url('update-permohonan-cancel')}}">
                    {{ csrf_field() }}
